...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            passport_1.PassportModule.register({ defaultStrategy: 'jwt' }), // Ensure jwt strategy is default
            // JWT Authentication Module
            jwt_1.JwtModule.registerAsync({
                useFactory: (configService) => __awaiter(void 0, void 0, void 0, function* () {
                    return ({
                        secret: configService.get('JWT_SECRET'), // Get JWT_SECRET from environment
        ...
        providers: [order_strategy_1.JwtStrategy], // Register JwtStrategy here
    })
], AppModule);
